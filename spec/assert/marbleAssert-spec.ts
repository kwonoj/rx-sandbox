...
describe('marbleAssert', () => {
  ...
  describe('TestMessage', () => {
    ...
    it('should pass observables', () => {
      ...
      expect(() => marbleAssert(s).to.equal(e)).not.toThrow();
    });
    ...
    it('should assert empty source', () => {
      expect(() => marbleAssert([]).to.equal(p('----s'))).toThrow();
    });

    it('should assert non-array expected', () => {
      expect(() => marbleAssert([]).to.equal('1' as any)).toThrow();
    });
    ...
    it('should assert observables frame', () => {
      ...
      expect(() => marbleAssert(s).to.equal(e)).toThrow();
    });
  ...
  describe('SubscriptionLog', () => {
    it('should pass if subscription matches', () => {
      ...
      expect(() => marbleAssert(source).to.equal(source)).not.toThrow();
    });
    ...
    it('should assert empty source', () => {
      expect(() => marbleAssert([]).to.equal([subscribe(10, 24)] as any)).toThrow();
    });
    ...
    it('should assert if subscription unmatches', () => {
      ...
      expect(() => marbleAssert(source).to.equal(expected)).toThrow();
    });
